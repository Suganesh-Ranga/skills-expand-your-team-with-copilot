...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', 'none' for activities without difficulty)
    """
    ...
    if difficulty:
        # Special case: 'none' means activities without a difficulty field
